<div class="row end mb desktop-only">
    ...
    <a href="/trees/<?= $tree ?>" class="btn nowrap" type="submit">Start of Tree</a>
    <a href="/trees/<?= $tree ?>?start=random " class="btn nowrap" type="submit">Random</a>
    <a href="/logout?__method=post" class="btn nowrap" type="submit" style="background-color: red">Logout</a>
</div>

<div class="row mb around mobile-only">
    <a href="/" class="btn nowrap" style="height: 2.2rem" type="submit">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
            <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
        </svg>
    </a>
    <a href="/trees/<?= $tree ?>" class="btn nowrap" style="height: 2.2rem" type="submit">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2z"/>
            <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466"/>
        </svg>
    </a>
    <a href="/trees/<?= $tree ?>?start=random " class="btn nowrap" style="height: 2.2rem" type="submit">
    ...
    <a href="/logout?__method=post" class="btn nowrap" style="height: 2.2rem; background-color: red" type="submit">
